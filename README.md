...
Fix it. The error message tells you which files contain the conflicts.
...
Issues are a great way to communicate: they keep topics well separated, and allow the repo's projects to be tracked well.
